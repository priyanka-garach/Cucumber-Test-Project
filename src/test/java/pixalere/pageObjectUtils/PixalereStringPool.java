...
public class PixalereStringPool {
	...
	public static final String O2SAT = "O2 saturation";

	public static final String HEIGHT_VITAL = "height";

	public static final String WEIGHT_VITAL = "weight";
	...
	public static final String RESVOLUMEBAG = "Reservoir volume bag cassette";

	public static final String DOSECONCEN = "Dose Concentration";

	public static final String DOSE_HOUR = "Dose_hour";

	public static final String BOLUS_DOSE = "Bolus dose";

	public static final String BOLUS_DOSE_ALLOWED_HOUR = "Bolus doses allowed hour";

	public static final String ATTEMPTS = "Attempts";

	public static final String GIVEN = "Given";

	public static final String TARGETWEIGHT = "Target Weight";

	public static final String TARGETBLOODPRESSURE = "Target Blood Pressure";
	...
	public static final String E_SUPPORT = "turn to for support";

	public static final String EMEMERGENCY_CONTACT = "Emergency contact";

	public static final String AlTERNATE_EMEMERGENCY_CONTACT = "Alternate emergency contact";

	public static final String EMEMERGENCY_RELATIONSHIP = "Emergency Relationship";

	public static final String ALETRNATE_EMEMERGENCY_RELATIONSHIP = "Alternate emergency Relationship";

	public static final String EMEMERGENCY_PHONE = "Emergency Phone";

	public static final String ALETRNATE_EMEMERGENCY_PHONE = "Alternate emergency Phone";

	public static final String E_Preparedness_plan = "emergency preparedness plan";

	public static final String E_COMMENTS = "Emergency Page Comments";

	public static final String OTHER_RADIO = "OtherRadio";

	public static final String OTHER_HOMEP = "Other";

	public static final String DRAINAGE_AMOUNT = "Drainage Amount";

	public static final String SOLUTION_USED = "SolutionUsed";
	...
	public static final String EXPECTED_OUTCOMES_REEVALUATION_DATE_CarePlan = "Expected Outcomes ReEvaluation Date";

	public static final String Edit_NURSING_DIAGNOSIS_CarePlan = "Edit Client Problem Nursing Diagnosis";

	public static final String Edit_INTERVENTIONS_ROUTINE_CarePlan = "Edit Interventions Routine Care";
	...
	public static final String IO_SOLID = "Solid";

	public static final String H2O = "H2O";

	public static final String IO_OTHER = "Other";

	public static final String IO_WATER = "Water";

	public static final String IO_FORMULA = "IOFormula";

	public static final String IO_WATER_BOLUS = "Water Bolus";

	public static final String IO_VOL_DELIVERED = "Volume to be Delivered";

	public static final String IO_VOL_INFUSED = "Volume Infused";

	public static final String IO_FLUSH_VOL = "Flush Volume";

	public static final String IO_TOTAL_VOL = "Total Volume";

	public static final String IO_RATE = "Rate";

	public static final String IO_FORMULA_NAME = "Formula Name";

	public static final String IO_VOID_VOL = "Void Volume";

	public static final String IO_No_of_WET_Diapers = "Number of wet diapers";

	public static final String IO_OSTOMY = "Ostomy";

	public static final String IO_DRAIN1 = "Drain 1";

	public static final String IO_DRAIN_LOCATION1 = "Drain Location1";

	public static final String IO_DRAIN2 = "Drain 2";

	public static final String IO_DRAIN_LOCATION2 = "Drain Location2";

	public static final String IO_DRAIN3 = "Drain 3";

	public static final String IO_DRAIN_LOCATION3 = "Drain Location3";
	...
	public static final String ZIP_CODE_POSTAL_CODE = "Zip Code/Postal Code";

	public static final String STATE_PROVINCE = "State/Province";

	public static final String PRIMARY_INSURANCE_CARRIER = "Primary Insurance Carrier";

	public static final String PRIMARY_INSURANCE_POLICY_HOLDER_NAME = "Primary Insurance Policy Holder Name";
	...
	public static final String PAST_MEDICAL_HISTORY_OTHER = "Past Medical History Other";

	public static final String CURRENT_MEDICATIONS = "Current Medications";

	public static final String ALBUMIN_G_L = "Albumin g/L";

	public static final String PREALBUMIN_MG_L = "Prealbumin mg/L";

	public static final String BLOOD_GLUCOSE_MMOL_L = "Blood Glucose mmol/L";

	public static final String BLOOD_GLUCOSE_TIME = "Blood Glucose Time";

	public static final String PURS_SCORE = "PURS Score";

	public static final String CAUSE_HISTORY = "Cause/History";

	public static final String SURGICAL_PROCEDURE = "Surgical Procedure";

	public static final String SURGEON = "Surgeon";

	public static final String DATE_OF_SURGERY = "Date of Surgery";

	public static final String ADD_PAIN_SCALE = "Add Pain Scale";

	public static final String PAIN_SCALE = "Pain-Scale";
	...
	public static final String UNDERMINING_AREA = "Undermining Area";

	public static final String UNDERMINING_DEPTH = "Undermining Depth";

	public static final String LOCATION_START = "Location Start";

	public static final String LOCATION_END = "Location End";

	public static final String SINUS_TRACTS_AREA = "Sinus Tracts Area";

	public static final String SINUS_TRACTS = "Sinus Tracts";

	public static final String SINUS_TRACTS_DEPTH = "Sinus Tracts Depth";

	public static final String NUMBER_OF_FISTULAS = "Number of Fistulas";

	public static final String NUMBER_OF_fISTULAS = "Number of fistulas";

	public static final String FISTULA = "Fistula";

	public static final String EXUDATE_CHARACTERISTICS = "Exudate Characteristics";

	public static final String ODOUR = "Odour";

	public static final String WOUND_EDGE = "Wound Edge";

	public static final String PERI_WOUND_SKIN = "Peri-Wound Skin";

	public static final String SELECT_PRODUCT = "Select a Product(s)";

	public static final String CURRENT_SYMPTOMS = "Do you currently have any of the following symptoms?";

	public static final String REVIEW_OF_SYSTEMS = "Review of Systems";

	public static final String OTHER_SYMPTOMS = "Other Symptoms";

	public static final String NURSE_DIAGNOSIS = "Nurse's Diagnosis";

	public static final String BIOPSY_YES = "What were the results of the Biopsy?";

	public static final String TREATMENTS_TRIED = "List any treatments tried and the response (if none, leave blank)";

	public static final String RECOMMENDATIONS = "Recommendations";

	public static final String FOLLOW_UP = "Follow-Up";

	public static final String SITE = "Any questions that need urgently answered";

	public static final String RESPONSE = "Response";

	public static final String OSTOMY_TEACHING_GOALS = "Ostomy Teaching Goals";

	public static final String PROFILE = "Profile";

	public static final String APPEARANCE = "Appearance";

	public static final String ABDOMINAL_CONTOUR = "Abdominal Contour";

	public static final String CONCERNS_FOR_POUCHING = "Concerns for Pouching";

	public static final String MUCOCUTANEOUS_MARGIN = "Mucocutaneous Margin";

	public static final String PERI_OSTOMY_SKIN = "Peri-Ostomy Skin";

	public static final String FISTULA_DRAINAGE = "Fistula Drainage";

	public static final String PERI_FISTULA_SKIN = "Peri-Fistula Skin";

	public static final String URINE_COLOUR = "Urine Colour";

	public static final String URINE_TYPE = "Urine Type";

	public static final String SELF_CARE_PROGRESS = "Self Care Progress";

	public static final String SELF_CARE_PROGRESS_COMMENTS = "Self Care Progress Comments";

	public static final String STOOL_COLOUR = "Stool Colour";

	public static final String STOOL_CONSISTANCY = "Stool Consistancy";

	public static final String CO_MORBIDITIES = "Co-morbidities";

	public static final String FACTORS_THAT_AFFECT_WOUND_HEALING = "Factors that Affect Wound Healing";

	public static final String PRIMARY_DIAGNOSIS = "Primary Diagnosis";

	public static final String OVERVIEW = "Overview";

	public static final String ICD10_CPT_CODES = "ICD10/CPT Codes";

	public static final String PAIN = "Pain";

	public static final String MEASUREMENTS = "Measurements";

	public static final String UNDERMINING_DEPTH_CM = "Undermining Depth(cm)";

	public static final String WOUND_PARTS = "Please indicate all parts of the body where the wound is present";

	public static final String DISEASE_MANAGEMENT_COMM = "Disease Management Comments";

	public static final String PHYSICAL_COMM = "Physical Comments";

	public static final String PSYCHOLOGICAL_COMM = "Psychological Comments";

	public static final String SOCIAL_COMM = "Social Comments";

	public static final String SPIRITUAL_COMM = "Spiritual Comments";

	public static final String PRACTICAL_COMM = "Practical Comments";

	public static final String END_OF_LIFE_COMM = "End of Life Comments";

	public static final String LOSS_AND_GRIEF_COMM = "Loss and Grief Comments";
	...
	public static final String LACK_OF_APPETITE = "Lack of Appetite";

	public static final String FEELING_OF_WELL_BEING = "Feeling of Well being";

	public static final String SHORTNESS_BREATH = "Shortness Breath";
	...
	public static final String AMBULATORY_PUMP = "Ambulatory Pump";

	public static final String HIGH_RISK_MEDICATION = "High Risk Medication";

	public static final String END_DATE = "End Date";

	public static final String DATE_ORDERED = "Date Ordered";

	public static final String LAST_DOSE_GIVEN_ON = "Last Dose Given On";
	...
	public static final String SITE_LOCATION = "Site Location";

	public static final String LOCATION_CHANGE = "Location Change";

	public static final String CANNULA = "Peripheral Cannula Size (gauge)";

	public static final String CENTRAL_LINE = "Central Line: External Length(cm)";

	public static final String PICC = "PICC: Circumference (cm)";

	public static final String OCCLUSION_ASSESSED = "Occlusion Assessed";

	public static final String OCCLUSION_DETECTED = "Occlusion Detected";

	public static final String OCCLUSION_QUALITY = "Occlusion Quality";

	public static final String OCCLUSION_SOURCE = "Occlusion Source";

	public static final String NORMAL_SALINE = "Normal Saline Flush (mL)";

	public static final String VOLUME_TBD = "Volume to be infused (mL)";

	public static final String VOLUME_INFUSED = "Volume Infused (mL)";

	public static final String RES_VOLUME = "Res Volume";

	public static final String DOSES_GIVEN = "Doses Given";

	public static final String BATTERY_CHECKED = "Battery Checked";

	public static final String BATTERY_CHANGED = "Battery Changed";

	public static final String TUBING_CHANGE = "Tubing Change";

	public static final String DRESSING_CHANGE = "Dressing Change";

	public static final String BAG_CHANGE = "Bag Change";

	public static final String CAP_CHANGE = "Cap Change";

	public static final String PORT_A_CATH_CHANGED = "Port-A-Cath Changed";

	public static final String PORT_A_CATH_GAUGE = "Port-A-Cath Gauge";

	public static final String HEPARIN_LOCK = "Heparin Lock";

	public static final String PHYSICIAN_NAME = "Physician's / Nurse Practitioner's Name";

	public static final String PROVIDERS_REPORT = "Providers Report";

	public static final String REASON_FOR_MARKED_IN_ERROR = "Reason for Marked in Error";

	public static final String DELETE_MEDICAL_UPDATE_LETTER = "Delete Medical Update Letter";
	...
	public static final String NPWT_MACHINE_SERIAL = "NPWT Machine Serial #";

	public static final String NPWT_VENDOR_CONFIRMATION = "NPWT Vendor Confirmation #";
