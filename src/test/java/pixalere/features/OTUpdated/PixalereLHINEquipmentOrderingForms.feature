...
And I enter "Building Name" input field OT
And I enter "Suite Number" input field OT
And I enter "Street Number" input field OT
And I enter "Street Name" input field OT
And I enter "City" input field OT
And I enter "Province" input field OT
And I enter "PostalCode" input field OT
...
And I enter "Delivery Time Instruction" input field OT
And I enter "Clinician's Name" input field OT
And I enter "Clinicians Contact Number" input field OT
And I enter "Delivery Instruction" input field OT
