...
#
And I enter "Dorsalis Pedis mm/Hg Right" input field
And I enter "Posterior Tibial mm/Hg Right" input field
And I enter "Ankle Brachial Pressure mm/Hg Right" input field
#
...
And I enter "Toe Pressure mm/Hg Right" input field
And I enter "Brachial Pressure mm/Hg Right" input field
#
...
#And I select "Abnormal skin dryness" checkbox for Right Concerns Foot field
And I select "Chronic Charcot" checkbox for Right Concerns Foot field
#
And I select "Dependent rubor" checkbox for Left Derm Assessment field ALB
And I select "Stasis dermatitis" checkbox for Left Derm Assessment field ALB
And I select "Varicosities" checkbox for Left Derm Assessment field ALB
#
